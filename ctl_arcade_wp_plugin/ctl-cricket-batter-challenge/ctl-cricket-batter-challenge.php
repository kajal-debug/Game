<?php
    /*
    Plugin Name: CTL Arcade - Cricket Batter Challenge
    Plugin URI: http://www.codethislab.com/
    Description: Cricket Batter Challenge for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeCricketBatterChallenge{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-cricket-batter-challenge";
        private $_szPluginName              = "Cricket Batter Challenge";
        private $_szAspectRatio             = "5:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "cricket, sport game, html5 game, html 5, sport, stick cricket, defend, bowler, batter, asian sport, baseball, commonwealth, football";
    ...
    $g_oCTLArcadeCricketBatterChallenge =  new CTLArcadeCricketBatterChallenge();
